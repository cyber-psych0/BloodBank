...
public class ReciepentForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReciepentForm frame = new ReciepentForm();
	...
	public ReciepentForm() {
		...
		comboBoxBgrp.setBounds(136, 212, 65, 24);
...
//				}
					...
					try {
						...
						if(ag < 0) {
							...
							if(curr_st<unt) {
								String msg = "Sorry!! We have only "+curr_st+" units blood left.";
								JOptionPane.showMessageDialog(null, msg);
								pst2.close();
							}
							else {
							String query = "insert into Reciepent (FirstName,Lastname,ContactNo,Sex,Age,City,BloodGrp,BloodUnit) values (?,?,?,?,?,?,?,?)";
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 92, 92), 3, true), "Recipient Form", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 92, 92)));
